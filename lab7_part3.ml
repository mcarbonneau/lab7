...
to q queuee (as described in Section 12.2) except that the last
...
element from the stack, and "pop", which returns a new stack that has
the topmost element removed.
...
let last_el = IntListTack.top (small_stack ());;
...
top value from a small_stack inverted with invert_stack and name the
result in bad_el.
......................................................................*)

let bad_el = IntListTack.top (invert_stack (small_stack () ));;
...
let safe_stack () : SafeIntListsStacks = 
let open SafeIntListsStack in
empty 
|> push 5
|> push 1 ;;
